...
> stdout does not match
    ...
    Skipped 0 files ignored in '.gitignore'␊
      Analysing test/fixtures/fixture-in-place.md...␊
       ...
       test/fixtures/fixture-in-place.md#L486-L488 Unsupported file extension [binary], supported extensions are txt, ts, js, re, rei, scss, rust, java, cpp, c, html, xml, md, yaml, json, json5, py, bash, sh, go, objectivec, php, cs, swift, rb, kotlin, scala, cr, puml, mermaid, cmake, proto, sql, hs, ino, skipping code block␊
